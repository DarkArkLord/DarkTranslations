...
function getAdventureText() {
    return [
        ...
        quickTextFormat(`После того, как родина Ночных Эльфов - гора Хиджал была спасена совместными силами Альянса, Орды и Стражей, три фракции объединились, чтобы защитить себя от дальнейших вторжений Короля-лича и его демонических союзников. Собрав силы, они отправили средний гарнизон, чтобы основать аванпост на берегах северного континента Нордскол. Около трех месяцев значительных проблем не было, однако около неделю назад из аванпоста перестали прилетать почтовые птицы. Поскольку все фракции поддерживали контакт только со своими представителями, каждая из них подозревает предательство со стороны остальных.`, { leadingIndent: paragraphOffset, }),
        ...
        getTipText([
            quickTextFormat(`И, опять же, это странно. Раз Арак-арахм контролирует нерубов - почему они нападают, раз считают персонажей приспешниками Короля-Лича? Если же это "мятежные" нерубы, то почему они отступают в логово, контролируемое буквально лейтенантом Короля-Лича? Я не знаю, как решить эту логическую несостыковку.`),
        ]),
        {
            ...
            getCharContent({
                ...
                bottomLines: [
                    ...
                    quickTextFormat(`**Пивовар (Brewmaster) (Направление (Channeling))**: **Пункты Силы**: 15; **Силы**: ${[
                        ...
                        `*${getFromDict(PowersTranslations, Powers.Stun)} (Одна цель - Облить алкоголем (Douse with alcohol))*`,
